...
//     public static void OnExport(IEnumerable<UnityEngine.Object> unityExportSet)
//     {
...
//         string filePath = Path.Combine(Application.dataPath, "MyGamelll.fbx");
//
...
//
//             if (fbxExporter.ExportAll(unityExportSet) > 0)
//             {
//                 Uploader.UploadFile();
